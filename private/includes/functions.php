...
function validRegister($data){
	...
	if (strlen($wachtwoord) <6 ){
		$errors['wachtwoord'] = 'Invalid Password';
	}
...
function sendConfirmationEmail($email, $code){
	...
	$message = createEmailMessage($email, 'Confirm your account', '12Move site', '12move@bobvanberckel.com');
	$email_text = 'Hi there! To confirm your account <a href=" ' . $absolute_url . '">Click here</a>';
